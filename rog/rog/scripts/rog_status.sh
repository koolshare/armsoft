...
RT-AC5300)
	...
	interface_2g_power=$(wl1 -i ${interface_2g} txpwr_target_max | awk '{print $NF}') 2>/dev/null
	interface_5g1_power=$(wl1 -i ${interface_5g1} txpwr_target_max | awk '{print $NF}') 2>/dev/null
	interface_5g2_power=$(wl1 -i ${interface_5g2} txpwr_target_max | awk '{print $NF}') 2>/dev/null
