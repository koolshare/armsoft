...
def work_parent():
    ignore_paths = frozenset(["maintain_files", "softcenter", "appledns", "speedtest", "dualwan", "kcptun", "koolnet", "kuainiao", "shadowvpn", "tunnel", "ssid", "koolproxy", "ssserver", "wifiboost", "xunyou"])
