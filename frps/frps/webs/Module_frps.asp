												...
												<tr id="switch_tr">
													...
													<td colspan="2">
														...
														<div style="float: right;margin-top:5px;margin-right:30px;">
															...
															<a type="button" href="https://raw.githubusercontent.com/koolshare/armsoft/master/frps/Changelog.txt" target="_blank" class="ks_btn" style="cursor: pointer;margin-left:5px;border:none" >更新日志</a>
